...
export function imp_resolveStateOutputParameter__has_initialization_data__initialization(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__source__no__has_initialization_data(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__source__yes__has_initialization_data(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["source"];
	if (switchResolutionStatus($state_context_value, data, 'source', onResolved, onError)) {
		interface_reply_resolver.imp_resolveStateContextValue__source__initialization(data.parent, function (err, $_scv_source) {
			if (err) {
...
export function imp_resolveStateOutputParameter__context_exists__yes__has_initialization_data(data, param, onResolved, onError) {
...
export function imp_resolveStateOutputParameter__type__notification(data, param, onResolved, onError) {
...
export function resolveComponentOutputParameter_delete_node(data, param, onResolved, onError) {
...
export function resolveComponentOutputParameter_initialize_node(data, param, onResolved, onError) {
	var $param_context = data;
	var $param_data = data.output_parameters[param];
	switch (param) {
		default:
...
export function imp_resolveStateOutputParameter__type__properties__initialize_node(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__collection__collection__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__component__component__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__text__file__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__group__group__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__number__number__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__reference__reference__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__state_group__state_group__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__text__text__type__properties__initialize_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["text"];
	if (switchResolutionStatus($state_context_value, data, 'text', onResolved, onError)) {
		interface_reply_resolver.imp_resolve_matrix_key__properties__initialize_node(data.parent, function (err, key) {
			if (err) {
...
export function imp_resolveStateOutputParameter__type__collection__type__properties__initialize_node(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__dictionary__dictionary__type__collection__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__matrix__matrix__type__collection__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateOutputParameter__type__number__type__properties__initialize_node(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__integer_type__integer__type__number__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__natural_type__natural__type__number__type__properties__initialize_node(data, onResolved, onError) {
...
export function imp_resolve_reference__state__state_group__type__properties__initialize_node (data, onResolved, onError) {
	var $context = data;
...
export function imp_resolve_matrix_key__properties__initialize_node (data, onResolved, onError) {
...
export function resolveComponentOutputParameter_update_node(data, param, onResolved, onError) {
	var $param_context = data;
	var $param_data = data.output_parameters[param];
	switch (param) {
		default:
...
export function imp_resolveStateOutputParameter__type__properties__update_node(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__collection__collection__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["collection"];
	if (switchResolutionStatus($state_context_value, data, 'collection', onResolved, onError)) {
...
export function imp_resolveStateContextValue__component__component__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["component"];
	if (switchResolutionStatus($state_context_value, data, 'component', onResolved, onError)) {
		interface_reply_resolver.imp_resolve_matrix_key__properties__update_node(data.parent, function (err, key) {
			if (err) {
...
export function imp_resolveStateContextValue__file__file__type__properties__update_node(data, onResolved, onError) {
...
export function imp_resolveStateContextValue__group__group__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["group"];
	if (switchResolutionStatus($state_context_value, data, 'group', onResolved, onError)) {
		interface_reply_resolver.imp_resolve_matrix_key__properties__update_node(data.parent, function (err, key) {
			if (err) {
...
export function imp_resolveStateContextValue__number__number__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["number"];
	if (switchResolutionStatus($state_context_value, data, 'number', onResolved, onError)) {
		interface_reply_resolver.imp_resolve_matrix_key__properties__update_node(data.parent, function (err, key) {
			if (err) {
...
export function imp_resolveStateContextValue__reference__reference__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["reference"];
	if (switchResolutionStatus($state_context_value, data, 'reference', onResolved, onError)) {
		interface_reply_resolver.imp_resolve_matrix_key__properties__update_node(data.parent, function (err, key) {
			if (err) {
...
export function imp_resolveStateContextValue__state_group__state_group__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["state group"];
	if (switchResolutionStatus($state_context_value, data, 'state group', onResolved, onError)) {
		interface_reply_resolver.imp_resolve_matrix_key__properties__update_node(data.parent, function (err, key) {
			if (err) {
...
export function imp_resolveStateContextValue__text__text__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["text"];
	if (switchResolutionStatus($state_context_value, data, 'text', onResolved, onError)) {
		interface_reply_resolver.imp_resolve_matrix_key__properties__update_node(data.parent, function (err, key) {
			if (err) {
...
export function imp_resolveStateOutputParameter__type__collection__type__properties__update_node(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__dictionary__dictionary__type__collection__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["dictionary"];
	if (switchResolutionStatus($state_context_value, data, 'dictionary', onResolved, onError)) {
...
export function imp_resolveStateContextValue__matrix__matrix__type__collection__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["matrix"];
	if (switchResolutionStatus($state_context_value, data, 'matrix', onResolved, onError)) {
		interface_reply_resolver.imp_resolveStateContextValue__collection__collection__type__properties__update_node(data.parent, function (err, $_scv_collection) {
			if (err) {
...
export function imp_resolveStateOutputParameter__type__entries__collection__type__properties__update_node(data, param, onResolved, onError) {
...
export function imp_resolve_reference__old_id__rename (data, onResolved, onError) {
	var $context = data;
...
export function imp_resolveStateOutputParameter__invalidate_referencer__update__type__entries(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__matrix__yes__invalidate_referencer(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["matrix"];
	if (switchResolutionStatus($state_context_value, data, 'matrix', onResolved, onError)) {
...
export function imp_resolveStateOutputParameter__type__number__type__properties__update_node(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__integer_type__integer__type__number__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["integer type"];
	if (switchResolutionStatus($state_context_value, data, 'integer type', onResolved, onError)) {
...
export function imp_resolveStateContextValue__natural_type__natural__type__number__type__properties__update_node(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["natural type"];
	if (switchResolutionStatus($state_context_value, data, 'natural type', onResolved, onError)) {
		interface_reply_resolver.imp_resolveStateContextValue__number__number__type__properties__update_node(data.parent, function (err, $_scv_number) {
			if (err) {
...
export function imp_resolve_reference__state__state_group__type__properties__update_node (data, onResolved, onError) {
	var $context = data;
	if (switchResolutionStatus(data.properties.state, data, 'TODO!', onResolved, onError)) {
...
export function imp_resolveStateOutputParameter__type__state_group__type__properties__update_node(data, param, onResolved, onError) {
...
export function imp_resolve_matrix_key__properties__update_node (data, onResolved, onError) {
	var $context = data.parent;
	if (switchResolutionStatus(data.key, data, 'TODO!', onResolved, onError)) {
		$context.imp_resolveInputParameter("context node", function (err, $_i_param_context_node) {
			if (err) {
...
export function imp_resolveStateOutputParameter__type__interface_reply(data, param, onResolved, onError) {
...
export function imp_resolveStateContextValue__source__initialization(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["source"];
	if (switchResolutionStatus($state_context_value, data, 'source', onResolved, onError)) {
...
export function imp_resolveStateContextValue__source__notification(data, onResolved, onError) {
	var $state_context_value = data.state_context_values["source"];
	if (switchResolutionStatus($state_context_value, data, 'source', onResolved, onError)) {
		data.parent.imp_resolveGlobalInputParameter("request", function (err, $_i_param_request) {
			if (err) {
