...
import * as application_protocol_shake from "./read_api";
import * as application_protocol_shake_resolver from "./reference_resolver";
...
export type Naked_application_protocol_shake = {
	_typescript_dummy_application_protocol_shake?:boolean;
};
export function imp_decorate_application_protocol_shake(api, $:Naked_application_protocol_shake, containing_node, meta_table, onError, input_parameters, lazy = false) { 
	var data = new api.Capplication_protocol_shake();
...
export function int_decorate(api, $:Naked_application_protocol_shake, input_parameters?, onError?:(err?:string) => void, lazy = false) {
	...
	var node = imp_decorate_application_protocol_shake(api, $, null, meta_table, onError, input_parameters, lazy);
	if (!lazy) {
		//reference resolving
		var ri;
...
export function decorate($:Naked_application_protocol_shake, input_parameters:{}, onError?:(err?:string) => void):read_api.Capplication_protocol_shake {
	return int_decorate(read_api, $, input_parameters, onError, false);
}
export function lazy_decorate($:Naked_application_protocol_shake, input_parameters:{}, onError?:(err?:string) => void):read_api.Capplication_protocol_shake {
