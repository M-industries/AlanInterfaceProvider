...
function imp_decorate_no(api, $, containing_node, meta_table, onError, resolveGlobalInputParameter, lazy) {
...
exports.imp_decorate_no = imp_decorate_no;
function imp_decorate_yes(api, $, containing_node, meta_table, onError, resolveGlobalInputParameter, lazy) {
    if (lazy === void 0) { lazy = false; }
...
exports.imp_decorate_yes = imp_decorate_yes;
var StateLookup__subscribe__application_protocol_hand = {
    "no": imp_decorate_no,
    "yes": imp_decorate_yes
};
function imp_decorate_application_protocol_hand(api, $, containing_node, meta_table, onError, input_parameters, lazy) {
    if (lazy === void 0) { lazy = false; }
    ...
    data.properties.subscribe = new read_api.StateGroup({ name: $["subscribe"][0], node: StateLookup__subscribe__application_protocol_hand[$["subscribe"][0]](api, $["subscribe"][1], data, meta_table, onError, resolveGlobalInputParameter, lazy) });
    data.output_parameters__subscribe__application_protocol_hand = {};
    return data;
}
exports.imp_decorate_application_protocol_hand = imp_decorate_application_protocol_hand;
