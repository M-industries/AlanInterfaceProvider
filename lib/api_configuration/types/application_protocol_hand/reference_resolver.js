...
function imp_resolveStateOutputParameter__subscribe__application_protocol_hand(data, param, onResolved, onError) {
    var $param_data = data.output_parameters__subscribe__application_protocol_hand[param];
    var $state_group = data.properties.subscribe;
    switch (param) {
        default:
            onResolved(true);
    }
}
exports.imp_resolveStateOutputParameter__subscribe__application_protocol_hand = imp_resolveStateOutputParameter__subscribe__application_protocol_hand;
;
