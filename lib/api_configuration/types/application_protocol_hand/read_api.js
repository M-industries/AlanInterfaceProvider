...
var Capplication_protocol_hand = (function (_super) {
    __extends(Capplication_protocol_hand, _super);
    function Capplication_protocol_hand() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_path = "'application_protocol_hand'";
        return _this;
    }
    Capplication_protocol_hand.prototype.getPath = function () {
        return '';
    };
    return Capplication_protocol_hand;
}(AlanNode));
exports.Capplication_protocol_hand = Capplication_protocol_hand;
var Cno = (function (_super) {
    __extends(Cno, _super);
    function Cno() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_path = "'application_protocol_hand'?'subscribe'*'no'";
        return _this;
    }
    Cno.prototype.getPath = function () {
        return this.parent.getPath() + "?'subscribe'*'no'";
    };
    return Cno;
}(StateNode));
exports.Cno = Cno;
var Cyes = (function (_super) {
    __extends(Cyes, _super);
    function Cyes() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_path = "'application_protocol_hand'?'subscribe'*'yes'";
        return _this;
    }
    Cyes.prototype.getPath = function () {
