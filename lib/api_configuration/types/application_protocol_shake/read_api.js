...
var Capplication_protocol_shake = (function (_super) {
    __extends(Capplication_protocol_shake, _super);
    function Capplication_protocol_shake() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_path = "'application_protocol_shake'";
        return _this;
    }
    Capplication_protocol_shake.prototype.getPath = function () {
        return '';
    };
    return Capplication_protocol_shake;
}(AlanNode));
exports.Capplication_protocol_shake = Capplication_protocol_shake;
