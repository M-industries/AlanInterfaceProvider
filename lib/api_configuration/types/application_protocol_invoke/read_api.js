...
var Capplication_protocol_invoke = (function (_super) {
    __extends(Capplication_protocol_invoke, _super);
    function Capplication_protocol_invoke() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_path = "'application_protocol_invoke'";
        return _this;
    }
    Capplication_protocol_invoke.prototype.getPath = function () {
        return '';
    };
    return Capplication_protocol_invoke;
}(AlanNode));
exports.Capplication_protocol_invoke = Capplication_protocol_invoke;
