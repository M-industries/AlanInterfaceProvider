...
var Cpackage_definition = (function (_super) {
    __extends(Cpackage_definition, _super);
    function Cpackage_definition() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_path = "'package_definition'";
        return _this;
    }
    Cpackage_definition.prototype.getPath = function () {
        return '';
    };
    return Cpackage_definition;
}(AlanNode));
exports.Cpackage_definition = Cpackage_definition;
var Clanguage = (function (_super) {
    __extends(Clanguage, _super);
    function Clanguage() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_path = "'package_definition'?'type'*'language'";
        return _this;
    }
    Clanguage.prototype.getPath = function () {
        return this.parent.getPath() + "?'type'*'language'";
    };
    return Clanguage;
}(StateNode));
exports.Clanguage = Clanguage;
var Cpackage = (function (_super) {
    __extends(Cpackage, _super);
    function Cpackage() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type_path = "'package_definition'?'type'*'package'";
        return _this;
    }
    Cpackage.prototype.getPath = function () {
