...
function imp_decorate_language(api, $, containing_node, meta_table, onError, resolveGlobalInputParameter, lazy) {
...
exports.imp_decorate_language = imp_decorate_language;
function imp_decorate_package(api, $, containing_node, meta_table, onError, resolveGlobalInputParameter, lazy) {
    if (lazy === void 0) { lazy = false; }
...
exports.imp_decorate_package = imp_decorate_package;
var StateLookup__type__package_definition = {
    "language": imp_decorate_language,
    "package": imp_decorate_package
};
function imp_decorate_package_definition(api, $, containing_node, meta_table, onError, input_parameters, lazy) {
    if (lazy === void 0) { lazy = false; }
    ...
    ;
    data.imp_resolveGlobalInputParameter = resolveGlobalInputParameter;
    data.properties.type = new read_api.StateGroup({ name: $["type"][0], node: StateLookup__type__package_definition[$["type"][0]](api, $["type"][1], data, meta_table, onError, resolveGlobalInputParameter, lazy) });
    data.output_parameters__type__package_definition = {};
    return data;
}
exports.imp_decorate_package_definition = imp_decorate_package_definition;
