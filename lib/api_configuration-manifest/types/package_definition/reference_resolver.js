...
function imp_resolveStateOutputParameter__type__package_definition(data, param, onResolved, onError) {
    var $param_data = data.output_parameters__type__package_definition[param];
...
exports.imp_resolveStateOutputParameter__type__package_definition = imp_resolveStateOutputParameter__type__package_definition;
;
